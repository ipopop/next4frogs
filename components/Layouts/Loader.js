...
// utilisation de styled-components car composant animée assez conséquent en terme de ligne de code
...
export const Loader = ({ text, status }) => {
	...
	return (
		...
		>
			<AnimatedTitle style={{ fontSize: matchMoreThanPhones ? "2rem" : "1rem" }}>
				{text}
			</AnimatedTitle>
